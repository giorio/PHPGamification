...
//        die();
    ...
    {
        $sql = 'INSERT INTO gm_user_badges (id_user, id_badge, badges_counter, grant_date) VALUES (:uid, :bid, 1, UTC_TIMESTAMP()) ON DUPLICATE KEY UPDATE badges_counter = badges_counter + 1';
        $params = array(
            ':uid' => $userId,
            ':bid' => $badgeId
        );
